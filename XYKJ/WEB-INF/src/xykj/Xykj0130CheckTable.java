...
public class Xykj0130CheckTable extends XysfljTableTag {
	//コンボBOXより選択
	...
	public Xykjlj_01301_Params param = null;
	...
	public Xykj0130CheckTable(Xykjlj_01301_Params p) {
		super("Xykj0130CheckTable", p);
		param = p;
	...
	//コンボBOXで選択された値をgetする
		 ...
		 select_publish = param.getValue(XykjljPUBLISHCOMCombo.NAME);//出版コード
	    //検索以外の場合は処理を行わない
