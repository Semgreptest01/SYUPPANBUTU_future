...
public class Xykj0230Renewday extends XysfljTableTag {
	//コンボBOXより選択
	...
	public Xykj0230Renewday(Xykjlj_02301_Params p) {
		super("Xykj0230Renewday", p); 
		param = p;
...
//			ResultSet rs = tdb.selectTable(sql); // SQL実行
	...
	public String createStartTagWithFrame(String f) {
		...
		tag.append("\t<COL style=\"width:150px\">\r\n");
