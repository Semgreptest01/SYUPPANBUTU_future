...
public class XykjljNewsPublishProductCombo extends XysfljCommonCombo{
	static public String NAME = "select_product";
	public XykjljNewsPublishProductCombo(XysfljParameters p){
		super(p,NAME);
		...
		try{
			...
			String selectedPublishcom = param.getValue(XykjljNewsPUBLISHCOMCombo.NAME);
			String sql = "";
