...
function keydown(e) {
    //--キ－コ－ドを文字に直す
    bksel = true;  
    bkobj = document.form1.text_usercd;
...
function getKEYCODE(e){
    ...
    function initial(){
        ...
        <%--var a = "<%=detailTable.usercd%>";--%>
            //alert("testest:" + a);
        if(document.form1.usercd.value == null){
            f.text_usercd.value = "";
            //alert("testest:" + document.form1.usercd.value);
        } else {
        	<%--f.text_usercd.value = "<%=detailTable.usercd%>";--%>
        	//f.text_usercd.value = document.form1.usercd.value;
        	f.text_usercd.value = document.form1.usercd2.value;
            //alert(document.form1.usercd.value);
        }
       // alert(f.text_usercd.value);
        //エラーの場合、アラートを出力
        if("<%=detailTable.kensaku_flg%>" == "1"){
            f.select_customertype.options[0].selected = true;
            <%--alert("<%=detailTable.alertmsg%>");--%>
            newErr(("<%=detailTable.alertmsg%>"));
            return;
        }
        //取引先種別の設定
        <%--if("<%=detailTable.customertype%>" == "1"){--%>
        if(document.form1.customertype2.value == "1"){
            f.select_customertype.options[1].selected = true;
            <%--} else if("<%=detailTable.customertype%>" == "2"){--%>
             } else if(document.form1.customertype2.value == "2"){
        ...
        <%if( "1".equals(detailTable.err_type) || "2".equals(detailTable.err_type) || "3".equals(detailTable.err_type)
        		|| "4".equals(detailTable.err_type) || "5".equals(detailTable.err_type) || "7".equals(detailTable.err_type)
        		|| "8".equals(detailTable.err_type)){%>
            ComChgBgColor(document.form1.text_usercd);
            <%}%>
        //入力された利用者コードが７桁以外の場合
        ...
        <% if("6".equals(detailTable.err_type)){%>
...
// --------------------------------------
    function submit_chk1(){
        ...
        if(document.form1.text_usercd.value.match(/\D/g)){
             ...
             bkmode = "numerr";
             newErr("利用者コードに数字以外の文字が入力されています。");
             //ComChgBgColor(document.form1.text_usercd);
             //enableBotton();
             return;
        }
        ...
        //bksel = true;  
        //bkobj = document.form1.text_usercd;
        //bkobj = document.form1.customer_cd1;
        if(!chk_customer_cd()){
             //alert("取引先コードの桁数が足りません。");
             bkmode = "enable2";
             newErr("取引先コードの桁数が足りません。");
             //enableBotton();
             return;
        }
        ...
        if(!chk_customer_cd2()){
             ...
             bkmode = "enable2";
             newErr("取引先コードに数字以外の文字が入力されています。");
             //enableBotton();
             return;
        }
        //取引先種別が選択されていない場合
...
// --------------------------------------
    function submit_chk2(){
       ...
       //if(document.form1.usercd2.value == "")
            //alert("利用者コードを指定してください。");
            bkmode = "serch1";
            newErr("利用者コードを指定してください。");
...
//                enableBotton();
        ...
        if(!change_chk()){
        	...
        	bkmode="serch5";
            newCfm("入力したデータが消えてしまいますがよろしいでしょうか？");
            	//enableBotton();
            return;
        }else{
...
// --------------------------------------
    ...
    function submit_chk3(){
        if(!change_chk()){
            //if(!confirm("入力したデータが消えてしまいますがよろしいでしょうか？")){
            if(!newCfm("入力したデータが消えてしまいますがよろしいでしょうか？")){
                return;
            }
        }
...
onkeydown = "return ComKeyDown();"> <!-- debug -->
...
-->
<COL style="WIDTH:90px"><COL style="WIDTH:300px"><COL style="WIDTH:100px"><COL style="WIDTH:480px">
<TBODY><TR>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;">利用者コード</TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;">
...
<%if(detailTable.user_cd[0] == null){%>
        <TD style="padding:0;"><INPUT size="28" type="text" name="text_usercd" value="" maxlength=7 autocomplete="off"></TD>
<%} else {%>
        <TD style="padding:0;"><INPUT size="28" type="text" name="text_usercd" value="<%=Xysflj_Common.htmlEnc(detailTable.user_cd[0])%>" maxlength=7 autocomplete="off"></TD>
<%}%>
</TR>
<TR>
    <TD style="padding:0;">　</TD>
...
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;">取引先コード</TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;">取引先名</TD>
</TR><TR>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd1" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[0])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[0]%></TD>
</TR>
<TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd2" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[1])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[1]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd3" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[2])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[2]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd4" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[3])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[3]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd5" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[4])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[4]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd6" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[5])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[5]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd7" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[6])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[6]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd8" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[7])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[7]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd9" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[8])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[8]%></TD>
</TR><TR>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
<TD style="padding:0;">　</TD>
    ...
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><INPUT size="28" type="text" name="customer_cd10" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[9])%>" maxlength=6 autocomplete="off"></TD>
    <TD style="padding:0;">　</TD>
    <TD style="padding:0;"><%=detailTable.customer_nm[9]%></TD>
</TR><TR>
</TR></TBODY>
</TABLE>
<BR>
...
<INPUT type ="hidden" name="usercd" value="<%=Xysflj_Common.htmlEnc(request.getParameter("usercd"))%>" >
<INPUT type ="hidden" name="usercd2" value="<%=Xysflj_Common.htmlEnc(detailTable.usercd)%>" >
<INPUT type ="hidden" name="customertype2" value="<%=Xysflj_Common.htmlEnc(detailTable.customertype)%>" >
<INPUT type ="hidden" name="customertype" value="<%=Xysflj_Common.htmlEnc(request.getParameter("customertype"))%>" >
<INPUT type ="hidden" name="err_type" value="" >
<!--取引先コード-->
<INPUT type ="hidden" name="customer1" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[0])%>" >
<INPUT type ="hidden" name="customer2" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[1])%>" >
<INPUT type ="hidden" name="customer3" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[2])%>" >
<INPUT type ="hidden" name="customer4" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[3])%>" >
<INPUT type ="hidden" name="customer5" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[4])%>" >
<INPUT type ="hidden" name="customer6" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[5])%>" >
<INPUT type ="hidden" name="customer7" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[6])%>" >
<INPUT type ="hidden" name="customer8" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[7])%>" >
<INPUT type ="hidden" name="customer9" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[8])%>" >
<INPUT type ="hidden" name="customer10" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_cd[9])%>" >

<INPUT type ="hidden" name="customernm1" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[0])%>" >
<INPUT type ="hidden" name="customernm2" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[1])%>" >
<INPUT type ="hidden" name="customernm3" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[2])%>" >
<INPUT type ="hidden" name="customernm4" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[3])%>" >
<INPUT type ="hidden" name="customernm5" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[4])%>" >
<INPUT type ="hidden" name="customernm6" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[5])%>" >
<INPUT type ="hidden" name="customernm7" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[6])%>" >
<INPUT type ="hidden" name="customernm8" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[7])%>" >
<INPUT type ="hidden" name="customernm9" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[8])%>" >
<INPUT type ="hidden" name="customernm10" value="<%=Xysflj_Common.htmlEnc(detailTable.customer_nm[9])%>" >
<%--
