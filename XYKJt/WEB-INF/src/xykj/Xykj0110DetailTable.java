 ...
 *  L002  2006/12/01 S.Sawada   発売日２重表示対応
 */
package xykj;
...
public class Xykj0110DetailTable extends XysfljTableTag {
	...
	private InputDataCol notitleCol;
	private InputDataCol sumCol;
	private InputDataCol day1Col;
	private Xykjlj_01101_Params param;
	private DetailTableData totalData = null;
//	private int cursor = 0;

	public String select_DEPT; //選択されたDEPTCLASS
	public String select_SUB; //選択されたSUBCLASS
	public String select_Issueform; //選択された発行形態
...
//L002 CHGE
	...
	public Xykj0110DetailTable(Xykjlj_01101_Params p) {
		super("Xykj0110DetailTable", p);
		param = p;
		...
		notitleCol = new InputDataCol("", 76, "D");
		sumCol = new InputDataCol("合計", 76, "E");

		addHeader(kencdCol);
		addHeader(kennmCol);
		addHeader(saledateCol);
		addHeader(notitleCol);
		addHeader(sumCol);

		//コンボBOXで選択された値をgetする
		select_DEPT = param.getValue(XykjljDeptClassCombo.NAME);
		select_SUB = param.getValue(XykjljSUBCLASSCombo.NAME);
		select_Issueform = param.getValue(XykjljISSUEFORMCombo.NAME);
		select_Brandform = param.getValue(XykjljBRANDCombo.NAME);
		select_Saledate = param.getValue(XykjljSALEDATECombo.NAME);
...
//L002 CHGE
	...
	private void getDbData() throws XysfljDB.DBException {
		...
		System.out.println(selectline1);
	...
	public Vector getDetailHeadData() {
		return tableHeaders;
	}
...
//			ResultSet rsMax = tdb.selectTable(sqlMax);
			...
			params[0][1] = select_Brandform;
			params[1][0] = Xysflj_Dbcom.DB_STR;
			params[1][1] = strSaledate;
			if (size > 2) {
				params[2][0] = Xysflj_Dbcom.DB_STR;
				params[2][1] = strJancode;
			}
...
//L002 CHGS
//			sql += " AND to_char(B.発売日,'YYYY/MM/DD') = '"
//				+ select_Saledate
...
//			ResultSet rs = tdb.selectTable(sql);
			...
			params2[0][1] = select_Brandform;
			params2[1][0] = Xysflj_Dbcom.DB_STR;
			params2[1][1] = strSaledate;
			if (size2 > 2) {
				params2[2][0] = Xysflj_Dbcom.DB_STR;
				params2[2][1] = strJancode;
			}
	...
	public String createStartTagWithFrame(String f) {
		...
		*/
		tag.append("<TABLE");
		int ds = 60 +60 + 65 + 85 + 70 + 70*maxday;
		...
		tag.append("\t<COL style=\"width:60px\">\r\n");
		tag.append("\t<COL style=\"width:65px\">\r\n");
	...
	public String createHeadTag() {
		...
		/*
				while(cnt < maxday){
					...
					tag.append(l.getHeadOptionTag());
					tag.append(">");
					tag.append(Integer.toString(cnt)+"日目");
		//			tag.append(l.getLabel());
					tag.append("<BR></TD>\r\n");
