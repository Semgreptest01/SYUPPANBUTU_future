...
public class Xykj0220CheckTable extends XysfljTableTag {
	//コンボBOXより選択
	...
	public Xykjlj_02201_Params param = null;
	...
	public Xykj0220CheckTable(Xykjlj_02201_Params p) {
		super("Xykj0220CheckTable", p);
		param = p;
...
//		fromCol = new InputDataCol2("From", 135, "B");
		...
		fromCol = new InputDataCol2("From", 274, "B");
...
//		tag.append("\t<COL style=\"width:200px\">\r\n");
		...
		tag.append("\t<COL style=\"width:274px\">\r\n");
