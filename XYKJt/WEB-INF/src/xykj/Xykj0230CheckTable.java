...
public class Xykj0230CheckTable extends XysfljTableTag {
	//コンボBOXより選択
	...
	public Xykjlj_02301_Params param = null;
	...
	public Xykj0230CheckTable(Xykjlj_02301_Params p) {
		super("Xykj0230CheckTable", p);
		param = p;
	...
	//コンボBOXで選択された値をgetする
		 ...
		 select_publish = param.getValue(XykjljNewsPUBLISHCOMCombo.NAME);//出版コード
	    //検索以外の場合は処理を行わない
