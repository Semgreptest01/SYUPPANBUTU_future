 ...
 * (ダウンロード)用クラス
 */
public class Xykjlj_01301Jd extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		//フォームデータ解析
		Xykjlj_01301_Params param = null;

		try {

			param = new Xykjlj_01301_Params(req);
...
// 2006/05/11変更(E10K移行対応)
		// ***** ﾛｸﾞ出力処理 START *****************************************************************************
			param.putLog( 9,			 											// 状態（初期表示時:0 ﾀﾞｳﾝﾛｰﾄﾞ:9）
						...
						XysfljGenericRules.SCREEN_NM_130, 							// 画面名称
						XysfljGenericRules.SCREEN_NM_130);							// 画面MSG

			// CSVファイルを出力
//			csvDownload(res, "Xykj1301.csv", csv1,csv2,csv3, getLineSeparator());
			csvDownload(res, "Xykj1301.csv", csv1,csv2,csv3, getLineSeparator(),detailTable.maxday);
