 ...
 * (ダウンロード)用クラス
 */
public class Xykjlj_02101Jd extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		//フォームデータ解析
		Xykjlj_02101_Params param = null;
	
		try {

			param = new Xykjlj_02101_Params(req);
...
// 2006/05/11変更(E10K移行対応)
		// ***** ﾛｸﾞ出力処理 START *****************************************************************************
			param.putLog( 9,			 											// 状態（初期表示時:0 ﾀﾞｳﾝﾛｰﾄﾞ:9）
						...
						XysfljGenericRules.SCREEN_NM_210, 							// 画面名称
						XysfljGenericRules.SCREEN_NM_210);							// 画面MSG
		// ***** ﾛｸﾞ出力処理  END  ****************************************************************************

			// CSVファイルを出力
//			csvDownload(res, "Xykj1101.csv", csv1,csv2,csv3, getLineSeparator());
			csvDownload(res, "Xykj2101.csv", csv1,csv2,csv3, getLineSeparator(),detailTable.renewday);
...
//			response.setContentType("application/data-download;charset=UTF-8");
			...
			if ( renewday != null && !renewday.equals("") ){
				out.print(",,DEPT-CLASS-SUBCLASS-発行形態実績" + kaigyo_cd );
			}
