...
public class Xykjlj_02201_Params extends XysfljParameters{

	//配置するＣｏｍｂｏＢｏｘ
	public 
	XykjljNewsPublishProductCombo ProductformCombo = null;
	XykjljNewsPUBLISHCOMCombo publishcomcombo;
	...
	public Xykjlj_02201_Params(HttpServletRequest request){
		super("Sxykj02201",request);
		

		//出版社
		publishcomcombo = new XykjljNewsPUBLISHCOMCombo(this);
		setControl(publishcomcombo);
		
		//銘柄
		ProductformCombo = new XykjljNewsPublishProductCombo(this);
