...
public class Xykjlj_02301_Params extends XysfljParameters{

    //配置するＣｏｍｂｏＢｏｘ
	public XykjljNewsPUBLISHCOMCombo publishcomcombo;
	...
	public Xykjlj_02301_Params(HttpServletRequest request){
		super("Sxykj02301",request);
