...
public class Xykjlj_PUBLISHSALEDATE extends XysfljParameters{
	public Xykjlj_PUBLISHSALEDATE(HttpServletRequest request){
...
//		Xykjlj_Common.publishsaledateList(dbCom,"",selectedpublishcom,selectedBrand,saletdateCode,saletdateName);
