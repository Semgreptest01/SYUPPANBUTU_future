...
final public class XysfljGenericRules{
	...
	public final static String CONT_PATH_XYKJ = Xysflj_Common.CONT_PATH;
	public final static String DOWNLOAD_PATH_XYKJ = Xysflj_Common.SERVLET_PATH;
//	public final static String FORM_STRING_CODE = "iso-8859-1";
	public final static String FORM_STRING_CODE = "UTF-8";
//	public final static String SOURCE_STRING_CODE = "EUC";
	public final static String SOURCE_STRING_CODE = "UTF-8";
//	public final static String DB_STRING_CODE = "Shift_JIS";
	public final static String DB_STRING_CODE = "UTF-8";
//	public final static String CLIENT_STRING_CODE = "Shift_JIS";
	public final static String CLIENT_STRING_CODE = "UTF-8";
...
//	public final static String DB_URL_SLAVE_SINGLE = "jdbc:oracle:thin:@10.64.8.29:1523:LE6B";
	public final static String DB_URL_SLAVE_SINGLE = "jdbc:oracle:thin:@localhost:11521/db_pdb1.sbntxqosdb001.vcnxqosdb001.oraclevcn.com"; // EP4

	public final static String DB_USER_SLAVE_SINGLE = "hxy022";
//	public final static String DB_PASS_SLAVE_SINGLE = "hxy022";
	public final static String DB_PASS_SLAVE_SINGLE = "P#ssworD#123";
	...
	public final static String SCREEN_NM_010 = "010 利用者コード～取引先コード登録";
	public final static String SCREEN_NM_110 = "110 DEPT-CLASS-SUBCLASS-発行形態";
	public final static String SCREEN_NM_120 = "120 出版社－発行形態";
	public final static String SCREEN_NM_130 = "130 出版社　銘柄／発売日 (全国）別";
	public final static String SCREEN_NM_210 = "210 DEPT-CLASS-SUBCLASS-発行形態";
