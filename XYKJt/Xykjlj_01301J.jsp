...
<TABLE style="table-layout:fixed; width:970px; border-spacing:0;">
<COL style="WIDTH:46px"><COL style="WIDTH:187px"><COL style="WIDTH:45px"><COL style="WIDTH:260px"><COL style="WIDTH:67px"><COL style="WIDTH:200px"><COL style="WIDTH:100px">
<TBODY><TR>
