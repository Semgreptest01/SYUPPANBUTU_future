...
<SCRIPT src="<%= XysfljGenericRules.CONT_PATH_XYKJ%>common/news_dept_subclass.js"></SCRIPT>
<SCRIPT src="<%= XysfljGenericRules.CONT_PATH_XYKJ%>common/news_subclass_issueform.js"></SCRIPT>
<SCRIPT src="<%= XysfljGenericRules.CONT_PATH_XYKJ%>common/news_issueform_product.js"></SCRIPT>
...
<BR>
<TABLE style="table-layout:fixed; width:905px; border-spacing:0;">
<COL style="WIDTH:41px"><COL style="WIDTH:190px"><COL style="WIDTH:90px"><COL style="WIDTH:215px"><COL style="WIDTH:39px"><COL style="WIDTH:265px"><COL style="WIDTH:65px">
...
<TBODY><TR>
	...
	<TD style="padding:0;" colspan="2"><%= (param.getControl(XykjljNewsProductCombo.NAME).createTag()) %></TD>
</TR><TR>
