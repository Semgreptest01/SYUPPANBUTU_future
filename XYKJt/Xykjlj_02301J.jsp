...
<TABLE style="table-layout:fixed; width:970px; border-spacing:0;">
<COL style="WIDTH:46px"><COL style="WIDTH:150px"><COL style="WIDTH:46px"><COL style="WIDTH:220px"><COL style="WIDTH:60px"><COL style="WIDTH:200px"><COL style="WIDTH:100px">
<TBODY><TR>
