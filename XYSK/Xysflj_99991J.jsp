...
<%
	...
	Enumeration msg_box = null;
	if (request.getAttribute("msg_box") != null) {
		msg_box = ((Vector)request.getAttribute("msg_box")).elements();
	}
%>
<HTML lang="ja">
<HEAD>
...
<link rel="stylesheet" type="text/css" href="ie10view2.css" />
...
<%
		String renban	=	Xysflj_Common.htmlEnc(request.getParameter("renban"));		// メニュー連番
		if( renban == null ){									// 
%>
