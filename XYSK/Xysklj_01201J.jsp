...
function getKEYCODE(e){
	...
	/*function timer() {
		...
		sendAjaxRqst( "/XYSK/xysk.Xysklj_ajax", prmArry, ajaxHndlr, true );
	}*/
...
<TBODY><TR>
	...
	<TD style="padding:0;"><%= (param.getControl(XyskljPUBLISHCOMCombo.NAME)).createTag()%></TD>
	...
	<TD style="padding:0;" colspan="3"><%= (param.getControl(XyskljPUBLISHBRANDCombo.NAME)).createTag()%></TD>
	<TD style="padding:0;">
...
<BR>
<TABLE CLASS="ie10tb61" style="table-layout:fixed; border-spacing:0;">
