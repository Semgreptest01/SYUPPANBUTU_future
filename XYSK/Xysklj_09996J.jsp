...
<TD style="padding:0;"><%--=renewdayTable.createTag()--%></TD>
</TR></TBODY>
</TABLE>
<TABLE CLASS="ie10tb41" style="table-layout:fixed; width:970px; border-spacing:0;">
<COL style="WIDTH:30px"><COL style="WIDTH:150px"><COL style="WIDTH:30px"><COL style="WIDTH:200px"><COL style="WIDTH:60px"><COL style="WIDTH:200px"><COL style="WIDTH:100px">
<TBODY><TR>
