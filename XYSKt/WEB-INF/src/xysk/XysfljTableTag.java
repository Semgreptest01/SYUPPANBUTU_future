...
public class XysfljTableTag{
	...
	protected String cls2 = "";
	protected String cls3 = "";
...
//	}
	...
	public void setCls2(String c) {
		cls2 = c;
	}
	protected String getCls2() {
		return " class=\"" + cls2 + "\"";
	}
	public void setCls3(String c) {
		cls3 = c;
	}
	protected String getCls3() {
		return " class=\"" + cls3 + "\"";
	}
	...
	public String createStartTagWithFrame(String f){
		...
		while(headers.hasMoreElements()){
			...
			tag.append("\t<COL style=\"width:" + w + "px\">\r\n");
		}
	...
	public void writeDataTag()
		...
		while(records.hasMoreElements()){
			...
			if(0 == printLines || printStartLine <= cursor && cursor < end || true == spanFlg){
				...
				if (!cls3.isEmpty())sb.append(getCls3());
				sb.append(">\r\n");
				...
				while(column.hasMoreElements()){
					...
					if(false == rowSpanFlg && false == colSpanFlg){
						...
						sb.append(" style=\"padding:" + cellpadding + ";\">\r\n");
						if (!cls2.isEmpty())sb.append(getCls2());
	...
	public void writeTag(){
		...
		try{
			...
			BigDecimal t = d.divide(new BigDecimal("1000"), 3, RoundingMode.HALF_UP);
			XysfljGenericRules.outputMessage("テーブルタグ出力(directWriteTag) 終了 " + t.toString() +"秒かかりました。",endCal);
		}
		catch(Throwable e){
...
//	}
	...
	static public String editRateValue(String val)
		...
		BigDecimal t = d.multiply(new BigDecimal("100"));
		t = t.divide(new BigDecimal("100"), 0, RoundingMode.HALF_UP);
		return Xysflj_Common.c_Edit(t.doubleValue(), 2);
	}
