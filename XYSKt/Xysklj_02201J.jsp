...
// * 02   2014/12/03  T.Katayama    Win8,IE11対応
// *---------------------------------------------------------------------
-->
<STYLE >
<!--
...
<SCRIPT src="<%= XysfljGenericRules.CONT_PATH_XYSK%>common/news_publishcom_product.js"></SCRIPT>
...
<BODY style="margin-top:5px; margin-left:10px; background-color:#F0FFFF;" onload="initial();" scroll="no"
 > <!-- debug -->
...
<COL style="WIDTH:40px"><COL style="WIDTH:150px"><COL style="WIDTH:40px"><COL style="WIDTH:200px"><COL style="WIDTH:30px"><COL style="WIDTH:200px"><COL style="WIDTH:100px">
<TBODY><TR>
	...
	<TD style="padding:0;">新聞社</TD>
	<TD style="padding:0;"><%= (param.getControl(XyskljNewsPUBLISHCOMCombo.NAME)).createTag()%></TD>
	...
	<TD style="padding:0;"></TD>
	<TD style="padding:0;">商品</TD>
	<TD style="padding:0;" colspan="3"><%= (param.getControl(XyskljNewsPublishProductCombo.NAME)).createTag()%></TD>
	<TD style="padding:0;">
...
<INPUT type ="hidden" name="inout" value="<%=Xysflj_Common.htmlEnc(request.getParameter("inout"))%>" >
