...
<COL style="WIDTH:40px"><COL style="WIDTH:150px"><COL style="WIDTH:40px"><COL style="WIDTH:200px"><COL style="WIDTH:60px"><COL style="WIDTH:200px"><COL style="WIDTH:100px">
<TBODY><TR>
...
<TABLE CLASS="ie10tb51 style="table-layout:fixed; border:1; border-spacing:0;">
