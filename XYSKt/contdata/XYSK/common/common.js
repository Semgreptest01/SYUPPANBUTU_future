...
//	3.	2006/04/24	K.Sasaki		var A_PASS = "/NASApp/XYSK/contdata/XYSK/class/"; 追加
//	4.	2014/12/03	T.Katayama		Win8,IE11対応
//-----------------------------------------------------------------------------------#
// 使用方法
...
//-----------------------------------------------------------------------------------
	$submit_sw = "0";
	$servlet_path		= "./";								// ***** OAS ****
//	$servlet_path		= "/XYSK/servlet/xysk.";			// ***** tomcat ****
//	$servlet_path		= "./";								// ***** iAS ****
//-----------------------------------------------------------------------------------
...
function msg_start( w_size, w_sw ){
   document.write('<TABLE CLASS="ie10tb21" style="width:' + w_size + 'px; border-spacing:0;"><TBODY><TR style="text-valign:top;"><TD style="text-align:left; padding:0;">');
   if( w_sw != "0" ){
   ...
   document.write('<TEXTAREA rows="1" cols="68" id="msg_out" placeholder="メッセージが表示されます"');
...
//	var A_PASS = "/NASApp/XYSK/contdata/XYSK/class/";	// ***** OAS      用のAPPLET_PASS *****
	var A_PASS = "/XYSK/contdata/XYSK/class/";			// ***** OAS(社外)用のAPPLET_PASS *****
//	var A_PASS = "/contdata/XYSK/class/";				// ***** iAS      用のAPPLET_PASS *****

//	******************* Tomcat / iAS の修正個所 END   *******************************

	g_name = G_name( g_id );	// *** 画面名称取得 ***
	document.write('<TABLE CLASS="ie10tb11" style="width:' + w_size + 'px; background-color:#0000FF;" >');
	...
	if( sw5 == 1 ){   // 日付時刻 ＳＷ？
		document.write('</TD>');
		//document.write('<TD nowrap style="background-color:#B0C4DE;height:20px;text-align:center;color:black;font-size:10pt;font-family:Gulim;width:146px;">');
...
/* ADD START KOGA 2004/03/17 */
	...
	i++;gamen_id[i]="Sxysk01201";	gamen_nn[i]="120 出版社－発行形態";
	i++;gamen_id[i]="Sxysk01301";	gamen_nn[i]="130 出版社　銘柄／発売日 (全国）別";
	i++;gamen_id[i]="Sxysk02201";	gamen_nn[i]="220 新聞社－発行形態";
	i++;gamen_id[i]="Sxysk02301";	gamen_nn[i]="230 新聞社　商品 (全国）別";
