...
//	public final static String CHAR_SET			= "Shift_Jis";						// Shift_Jis or x-euc-jp
	...
	public final static String CONT_PATH		= "/XYSKt/contdata/XYSK/";			// "/contdata/XE/" or "../../contdata/XE/"
	public final static String JSP_PATH			= "/";								// JSP PATH
//	public final static String SERVLET_PATH		= "/XYSK/servlet/xysk.";			// "/NASApp/XY/" or "/XYDL/servlet/xydl."
	public final static String SERVLET_PATH		= "/XYSKt/xysk.";			// "/NASApp/XY/" or "/XYDL/servlet/xydl."
	public final static String JNDI_NAME		= "jdbc/XYSKt_ORACLE901";			// JNDI Name( 192.20.31.126 LDAP
...
//	public static String THIN_DRIVER_URL		= "jdbc:oracle:thin:@10.44.74.33:1523:ltwtk2"; // EP4
	...
	public final static String DRIVER_NAME		= "oracle.jdbc.driver.OracleDriver";// Driver Name
//	public static String DB_USER				= "hxy022";							// DB User ID
//	public static String DB_PASS				= "hxy022";		
...
//	public static String DB_USER				= "oue001H";							// DB User ID
//	public static String DB_PASS				= "oue001H";							// DB Password
	public static String DB_IP					= "10.64.8.29";					// DB Machine IP
...
//				ResultSet rs = dbcom.querySQL(con, sql); 						// Execute Query
				ResultSet rs = dbcom.querySQL(con, sql, params); 						// Execute Query
				if(rs.next()){													// +++ rs.next +++
				  DB_IP = rs.getString("RMT_IP");
//				  System.out.println( DB_IP );
				  if ( DB_IP.equals("192.254.6.22") ) {
...
//					rs = dbcom.querySQL(connection, sql);							// Execute Query
					...
					params2[0][1] = sosiki_cd;

					rs = dbcom.querySQL(connection, sql, params2);							// Execute Query
...
//			}
		...
		try{																		// *try*
			...
			//System.out.println( "renban=" + renban + " sts="  + err_sw + " today =" + cstmt.getString(3) ); // debug
	...
	*/
	public static boolean getParam( HttpServletRequest	request,
		...
		try{
			String s;
			String as[];
			for(	Enumeration obj = request.getParameterNames();
				obj.hasMoreElements();
