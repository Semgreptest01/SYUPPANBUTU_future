...
//				getData_New(sql,"publishcom_cd","publishcom_nn");
				getData_New(sql,"publishcom_cd","publishcom_nn", null);
			} else {
...
//				getData_New(sql,"publishcom_cd","publishcom_nn");
				...
				getData_New(sql,"publishcom_cd","publishcom_nn", params);
				i=i+1;
				}
