...
*/
	protected void getData(String sql,String code,String name, String[][] params)
		throws XysfljDB.DBException{
		try{
			XysfljDB tdb = param.getDbConnection();

			ResultSet rs = tdb.selectTable(sql, params);
			while(null != rs && rs.next()){
//					comboElements.put(rs,code,name);
				comboElements.put(rs,code,Xysflj_Common.getStrCvt(name));
			}
...
/*	protected void getsaleData(String sql,String code,String codeZ)
	...
	protected void getsaleData(String sql,String code,String codeZ, String[][] params)
		throws XysfljDB.DBException{
		try{
			XysfljDB tdb = param.getDbConnection();
...
//				comboElements.put(rs,code,Xysflj_Common.getStrCvt(name));
	...
	protected void getData_New(String sql,String code,String name, String[][] params)
		throws XysfljDB.DBException{
		try{
			XysfljDB tdb = param.getDbConnection();
...
/*	protected void getDataCodeName(String sql,String code,String name)
	...
	protected void getDataCodeName(String sql,String code,String name, String[][] params)
		throws XysfljDB.DBException{
		try{
			XysfljDB tdb = param.getDbConnection();
