...
public class XysfljDB extends XysfljDBCore
{
	...
	static protected Hashtable createConnectionSet(){
		...
		ht.put("XYKJ",new ConnectionProperty("jdbc:oracle:thin:@10.64.8.29:1523:LE6B","hxy022","hxy022"));
//		ht.put("XYKJ",new ConnectionProperty("jdbc:oracle:thin:@10.173.6.107:1521:ORCL","hxy022","hxy022"));
//		ht.put("XYKJ",new ConnectionProperty("jdbc:oracle:thin:@10.64.8.40:1521:LE4A","hxy022","hxy022"));
		return ht;
	}
