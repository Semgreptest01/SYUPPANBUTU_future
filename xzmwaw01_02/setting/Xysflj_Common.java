...
* 06  2006/06/29 O.Ogawara		不使用なメソッドのコメントアウト
*-------------------------------------------------------------------------------
*/
package xykj;
...
/*
	...
	public final static String CHAR_SET			= "UTF-8";							// Shift_Jis or x-euc-jp
	public final static String CONT_PATH		= "/XYKJ/contdata/XYKJ/";	// "/CONTDATA/XY/" or "../CONTDATA/XY/"
	public final static String JSP_PATH			= "/";								// JSP PATH
	public final static String SERVLET_PATH		= "/XYKJ/xykj.";		// "/NASApp/XETEST/" or "/XETEST/servlet/xetest."
	public final static String JNDI_NAME		= "jdbc/XYKJ_ORACLE022";			// JNDI Name
...
//	public final static String CONT_PATH		= "/contdata/XYKJ/";				// "/CONTDATA/XY/" or "../CONTDATA/XY/"
//	public final static String JSP_PATH			= "/";								// JSP PATH
//	public final static String SERVLET_PATH		= "/NASApp/XYKJ/";					// "/NASApp/XETEST/" or "/XETEST/servlet/xetest."
//	public final static String JNDI_NAME		= "jdbc/XYKJ_ORACLE022";			// JNDI Name( 192.20.31.126 LDAP )
//	public static String THIN_DRIVER_URL		= " ";
//	public final static String DRIVER_NAME		= "oracle.jdbc.driver.OracleDriver";// Driver Name
...
//	public static String DB_IP					= "10.64.8.29";						// DB Machine IP
	...
	public final static String CON_SW			= "1";								// 1:JNDI(iAS)　2:Tomcat　3:J2SDKEE
	public final static String CHAR_SET			= "UTF-8";						// Shift_Jis or x-euc-jp
	public final static String CONT_PATH		= "/XYKJt/contdata/XYKJ/";			// "/contdata/XE/" or "../../contdata/XE/"
	public final static String JSP_PATH			= "/";								// JSP PATH
	public final static String SERVLET_PATH		= "/XYKJt/xykj.";			// "/NASApp/XY/" or "/XYDL/servlet/xydl."
//	public final static String JNDI_NAME		= "jdbc/XYKJ_ORACLE022";			// JNDI Name( 192.20.31.126 LDAP
	public final static String JNDI_NAME		= "jdbc/XYKJt_ORACLE901";
...
//	public static String THIN_DRIVER_URL		= "jdbc:oracle:thin:@10.64.8.29:1523:LE6B"; // EP4
	public static String THIN_DRIVER_URL		= "jdbc:oracle:thin:@localhost:11521/db_pdb1.sbntxqosdb001.vcnxqosdb001.oraclevcn.com"; // EP4

	public final static String DRIVER_NAME		= "oracle.jdbc.driver.OracleDriver";// Driver Name
//	public static String DB_USER				= "hxy022";							// DB User ID
//	public static String DB_PASS				= "hxy022";							// DB Password
	public static String DB_USER				= "oup901";		
	public static String DB_PASS				= "oup901";
//	public static String DB_PASS				= "P#ssworD#123";							// DB Password
	public static String DB_IP					= "10.64.8.29";					// DB Machine IP
...
*/
//	*********** E10K移行時 06 コメント化(2006/06/29) END *****************************************
	/**
	********************************************************************************
	* メソッド名		sosiki_Chk
	* @param		Xysflj_Dbcom	dbcom
...
//				ResultSet rs = dbcom.querySQL(connection, sql); 					// Execute Query
				...
				params[0][1] = sosiki_cd;
				
				ResultSet rs = dbcom.querySQL(connection, sql, params); 					// Execute Query
				if(rs.next()){														// +++ rs.next +++
					// DRデータがみつかった
					rs.close(); 													// Close
					dbcom.DBDisconnect(connection); 								// Disconnect
...
//					rs = dbcom.querySQL(connection, sql);							// Execute Query
					rs = dbcom.querySQL(connection, sql, params);							// Execute Query
...
//		return true;
		final Logger logger = Logger.getLogger(Xysflj_Common.class.getName());
...
//			connection = dbcom.DBConnect("hxy022", "hxy022");						// connection
			connection = dbcom.DBConnect(DB_USER, DB_PASS);						// connection
			logger.log(Level.INFO, "DBConnect:time_Chk");
...
//				cstmt = connection.prepareCall("begin sfzzop001.main(?, ?, ?); end;");	// Oracle Stored Function Call
				cstmt = connection.prepareCall("begin UPBBOP901.main(?, '0', ?, ?); end;");	// Oracle Stored Function Call
			} else {
//				cstmt = connection.prepareCall("begin smzzop001.main(?, ?, ?); end;");	// Oracle Stored Function Call
				cstmt = connection.prepareCall("begin UPBBOP901.main(?, '1', ?, ?); end;");	// Oracle Stored Function Call
			}
...
public static Vector getTorihikisakiCD ( Xysflj_Dbcom	dbcom,
		...
		try{
			Connection connection = dbcom.DBConnect(DB_USER, DB_PASS);		// DB connection
			logger.log(Level.INFO, "DBConnect:getTorihikisakiCD");
				sql	=	"SELECT 取引先コード"
						+	" ,種別区分"
						+	" FROM UPM_利用者_取引"
//						+	" WHERE 利用者コード='" + userid + "'"
...
//	*********** E10K移行時追加(2006/04/26) *****************************************
	...
	*/
	...
	public static String sqlEnc(String s) {
		String ret = "";
