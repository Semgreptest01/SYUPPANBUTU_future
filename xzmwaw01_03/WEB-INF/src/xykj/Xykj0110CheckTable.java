...
public class Xykj0110CheckTable extends XysfljTableTag {
	//コンボBOXより選択
...
//L002 ADDE
	...
	public Xykj0110CheckTable(Xykjlj_01101_Params p) {
		super("Xykj0110CheckTable", p);
		param = p;
...
//		toCol = new InputDataCol("To", 115, "C");
		...
		fromCol = new InputDataCol2("From", 248, "B");
		toCol = new InputDataCol("To", 128, "C");
...
/*
		 ...
		 Saledate = select_Saledate.substring(2,10);
...
//L002 CHGS
//			intSaledate2 = Integer.parseInt(select_Saledate.substring(0, 4)) * 10000;
//			intSaledate2 = intSaledate2 + (Integer.parseInt(select_Saledate.substring(5, 7)) * 100);
//			intSaledate2 = intSaledate2 + (Integer.parseInt(select_Saledate.substring(8,10)) * 1);
...
//			ResultSet rs = tdb.selectTable(sql); // SQL実行
			...
			params[1][1] = strSaledate2;
			if (size > 2) {
				params[2][0] = Xysflj_Dbcom.DB_STR;
				params[2][1] = strJancode2;
			}
...
//		tag.append("\t<COL style=\"width:115px\" >\r\n");
		...
		tag.append("\t<COL style=\"width:248px\" >\r\n");
		tag.append("\t<COL style=\"width:128px\" >\r\n");
...
//						chk3_uriage_type = rs.getString("出版社名");
						// **** END ******************************
	//					chk4_uriage_type = rs.getString("saledate");
