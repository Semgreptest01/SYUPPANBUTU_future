...
public class Xykj0120DetailTable extends XysfljTableTag {
	...
	private Xykjlj_01201_Params param;
...
//  private int intSaledate = 0;
    ...
    private String Zflg = "";
//L002 CHGE
	public Xykj0120DetailTable(Xykjlj_01201_Params p) {
		super("Xykj0120DetailTable", p);
		param = p;
...
//			ResultSet rs = tdb.selectTable(sql);
	...
	public String createStartTagWithFrame(String f) {
		if (((Xykjlj_01201_Params.COMMAND_REFERENCE == ct)
			...
			*/
			tag.append("<TABLE");
			int ds = 55 + 60 + 65 + 85 + 70 + 70*maxday;
			setStyle(
			...
			tag.append("\t<COL style=\"width:55px\">\r\n");
