...
public class Xykj0220DetailTable extends XysfljTableTag {
	...
	private Xykjlj_02201_Params param;
...
//	private int cursor = 0;
	...
	public Xykj0220DetailTable(Xykjlj_02201_Params p) {
		super("Xykj0220DetailTable", p);
		param = p;
		...
		//コンボBOXで選択された値をgetする
		select_Productform = param.getValue(XykjljNewsPublishProductCombo.NAME);
		select_publish = param.getValue(XykjljNewsPUBLISHCOMCombo.NAME);

		//検索以外の場合は処理を行わない
		if ((Xykjlj_02201_Params.COMMAND_REFERENCE == ct)
			|| (Xykjlj_02201_Params.COMMAND_DOWNLOAD == ct)) {
			try {
...
//			rs = tdb.selectTable(sql);
	...
	public String createTag() throws NoDataException, SpanException {
		...
		if (((Xykjlj_02201_Params.COMMAND_REFERENCE == ct)
			...
			if ( Xykjlj_02201_Params.COMMAND_REFERENCE == ct ) {
				...
				tag.append("<DIV id=\"BODY1\" style=\"height: 400px; width:996px; overflow:auto;\">");
				tag.append(createStartTag());
	...
	public String createStartTagWithFrame(String f) {
		if (((Xykjlj_02201_Params.COMMAND_REFERENCE == ct)
			...
			tag.append("<TABLE");
			int ds = 50 +60 + 85 + 70 + 50*param.printDays;
