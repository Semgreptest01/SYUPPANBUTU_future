 ...
 */
public class XykjljSelectLine1Combo extends XysfljComboTag{
	final static public String NAME = "select_selectline1";
	final static public int TYPE = XysfljParameters.ESSENTIAL;

	final public static String Init   	= "0";
