 ...
 * (ダウンロード)用クラス
 */
public class Xykjlj_02201Jd extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		//フォームデータ解析
		Xykjlj_02201_Params param = null;

		try {

			param = new Xykjlj_02201_Params(req);
...
// 2006/05/11変更(E10K移行対応)
		...
		// ***** ﾛｸﾞ出力処理  END  ****************************************************************************
			...
			// CSVファイルを出力
//			csvDownload(res, "Xykj2201.csv", csv1,csv2,csv3, getLineSeparator());
			csvDownload(res, "Xykj2201.csv", csv1,csv2,csv3, getLineSeparator(),detailTable.renewday);
