...
<SCRIPT src="<%= XysfljGenericRules.CONT_PATH_XYKJ%>common/publishcom_brand.js"></SCRIPT>
<SCRIPT src="<%= XysfljGenericRules.CONT_PATH_XYKJ%>common/publishbrand_saledate.js"></SCRIPT>
...
<TABLE style="table-layout:fixed; width:970px; border-spacing:0;">
<COL style="WIDTH:40px"><COL style="WIDTH:150px"><COL style="WIDTH:40px"><COL style="WIDTH:250px"><COL style="WIDTH:30px"><COL style="WIDTH:200px"><COL style="WIDTH:100px">
<TBODY><TR>
	...
	<TD style="padding:0;"><%= (param.getControl(XykjljPUBLISHCOMCombo.NAME)).createTag()%></TD>
	...
	<TD style="padding:0;" colspan="3"><%= (param.getControl(XykjljPUBLISHBRANDCombo.NAME)).createTag()%></TD>
	<TD style="padding:0;">
